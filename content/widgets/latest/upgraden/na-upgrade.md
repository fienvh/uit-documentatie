...
## Weergave
### Smalle weergave
Plak je je widget in in een smalle container (< 570px), dan is mobiele weergave in de meeste gevallen wenselijk. Je kan de smalle weergave forceren via [geavanceerde instellingen]({% link content/widgets/latest/geavanceerd.md %}).
...
Een vertaaltabel om je query van API 1-syntax te vertalen naar API 3-syntax vind je [hier]({% link content/widgets/latest/upgraden/vertaaltabel.md %}).
...
Je kan je widget na de upgrade nog [verder configureren en finetunen]({% link content/widgets/latest/configureren.md %}).
