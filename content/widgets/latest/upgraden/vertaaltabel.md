...
* Neem dan een kijkje op de [documentatiepagina van SAPI 3]({% link content/search_api_3/latest/getting-started.md %}). Voor widgets dien je steeds gebruik te maken van de syntax onder ‘Advanced queries’.
...
* [type aanbod]({% link content/uitdatabank/latest/categorisatie/type_aanbod.md %})
* [thema's]({% link content/uitdatabank/latest/categorisatie/themas.md %})
...
Voor het geografisch afbakenen van je query kan je in SAPI 3 gebruik maken van NIS-codes. De verschillende NIS-codes vind je [hier]({% link content/search_api_3/latest/searching/geosearch/list_of_shapes.md %}) Er is ook een specifieke vertaaltabel voor de regio's.
