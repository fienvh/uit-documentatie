...
When searching by [geo distance]({% link content/search_api_3/latest/searching/offers/geosearch/distance.md %}), it is possible to sort the results by the distance from the given coördinates.
